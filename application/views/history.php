                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">BY</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $checkId = 0 ?>
                                    <?php foreach ($barang as $b) : ?>
                                        <tr id="data_list">
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= $b["checkout_id"] ?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 align-middle text-center"><?= $b["quantity"] ?></p>
                                            </td>
                                            ...
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold">Rp<?= $b["total"] ?></span>
                                            </td>

                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?= date("Y-m-h", $b["tanggal"]) ?></span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span class="text-secondary text-xs font-weight-bold"><?php
                                                                                                        $name = $this->db->where(["id" => $b["user_id"]])->get("users")->row_array();
                                                                                                        echo $name["name"];
                                                                                                        ?></span>
                                            </td>
                                            <?php
